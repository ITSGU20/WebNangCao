...
function admin_sidebar(string $active): void {
    ...
    echo '<div style="padding:1.5rem 1.5rem 1rem;margin-top:auto">
        ...
        <a href="' . ADMIN_URL . '/logout.php" class="btn btn-danger btn-sm mt-2" style="width:100%;justify-content:center">🚪 Đăng xuất</a>
