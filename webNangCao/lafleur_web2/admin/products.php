...
<div class="card">
  ...
  <?= admin_pagination($paged, ADMIN_URL.'/products.php', array_filter(compact('search')+['cat'=>$catF,'status'=>$statusF])) ?>
</div>

<?php if ($showModal): ?>
<div class="modal-overlay active" onclick="if(event.target===this)location.href='<?= ADMIN_URL ?>/products.php'">
  <div class="modal" style="max-width:640px">
    <div class="modal-header">
      <h3><?= $editP?'Sửa sản phẩm':'Thêm sản phẩm' ?></h3>
      <a href="<?= ADMIN_URL ?>/products.php" class="modal-close">✕</a>
    </div>
    <form method="POST" enctype="multipart/form-data">
      ...
      <div class="modal-footer">
        <a href="<?= ADMIN_URL ?>/products.php" class="btn btn-outline">Huỷ</a>
